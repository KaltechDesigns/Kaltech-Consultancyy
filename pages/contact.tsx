...
const handleSendEmail = async (
  contactDeltails: emailInfoType,
  setLoading: any,
  setErrors: any,
  setContactDeltails: any
) => {
  setLoading(true);
  const errors: any = {};

  // Validation
  if (!contactDeltails.fullName) errors.fullName = "Name is required";
  if (!contactDeltails.email) errors.email = "Email is required";
  if (!contactDeltails.message) errors.message = "Message is required";
  if (!contactDeltails.subject) errors.subject = "Subject is required";
...
const Contact: React.FC = () => {
  ...
  return (
    <>
              ...
              >
                <div className="flex justify-between items-center gap-10 w-full">
                  <div className="w-[50%]">
                    <input
                      type="text"
                      className={`w-full font-[Oxanium] font-[400] text-lg placeholder:text-[#121212] py-2 px-3 outline-none border-b-2 ${
                        errors.fullName ? "border-red-500" : "border-[#C2C2C2]"
                      } bg-transparent`}
                      placeholder="Name *"
                  ...
                  <div className="w-[50%]">
                    <input
                      type="text"
                      className={`w-full font-[Oxanium] font-[400] text-lg placeholder:text-[#121212] py-2 px-3 outline-none border-b-2 ${
                        errors.email ? "border-red-500" : "border-[#C2C2C2]"
                      } bg-transparent`}
                      placeholder="Email *"
                      onChange={handleChange}
                      name="email"
                ...
                <div className="flex justify-between items-center gap-10 w-full">
                  ...
                  <div className="w-[50%]">
                    <input
                      type="text"
                      className={`w-full font-[Oxanium] font-[400] text-lg placeholder:text-[#121212] py-2 px-3 outline-none border-b-2 ${
                        errors.subject ? "border-red-500" : "border-[#C2C2C2]"
                      } bg-transparent`}
                      placeholder="Subject *"
                      onChange={handleChange}
                      name="subject"
                ...
                <div className="flex justify-between items-center gap-10 w-full">
                  <div className="w-full">
                    <textarea
                      className={`w-full font-[Oxanium] font-[400] text-lg placeholder:text-[#121212] py-2 px-3 outline-none border-b-2 ${
                        errors.message ? "border-red-500" : "border-[#C2C2C2]"
                      } bg-transparent`}
                      placeholder="Message *"
                      onChange={handleChange}
                      name="message"
      ...
      <ContactTab
        contactDeltails={contactDeltails}
        handleChange={handleChange}
        isLoading={isLoading}
        handleSendEmail={handleSendEmail}
        setIsLoading={setIsLoading}
        setErrors={setErrors}
        setContactDeltails={setContactDeltails}
      />
      <ContactMob
        contactDeltails={contactDeltails}
        handleChange={handleChange}
          ...
          <div className="flex justify-between items-center w-full my-4">
            ...
            >
              ...
              <motion.button
                ...
                className="text-[#2C2C2C] flex justify-center items-center gap-2 font-[Oxanium] font-[400] text-base w-32 h-32 border border-[#2C2C2C]  rounded-full relative hoverAnimationContactBTN overflow-hidden z-10 transition-colors duration-200 ease-in-out delay-100 self-center p-3 disabled:opacity-55 "
                disabled={isLoading}
              >
                {isLoading ? "Sending..." : "Send Message"}
                <span>
        ...
        <div className="w-[90%]">
          ...
          <div className="flex flex-col justify-center items-center gap-5 my-5">
            ...
            <motion.button
              ...
              className="text-[#2C2C2C] flex justify-center items-center gap-2 font-[Oxanium] font-[400] text-sm w-28 h-28 border border-[#2C2C2C]  rounded-full relative hoverAnimationContactBTN overflow-hidden z-10 transition-colors duration-200 ease-in-out delay-100 self-center p-3 disabled:opacity-55 "
              disabled={isLoading}
            >
              {isLoading ? "Sending..." : "Send Message"}
              <span>
